...
func (s *clusterConf) TestSetDHCP() {
	...
	tests := []struct {
		...
		{desc: "missing arg: duration"},
		{desc: "missing arg: net.IP",
			conf: clusterconf.DHCPConfig{
				Duration: 1,
			},
		},
		{desc: "invalid arg: net.IP must be IPv4",
			conf: clusterconf.DHCPConfig{
				Duration: 1,
				Net: net.IPNet{
					IP: net.ParseIP("::1"),
		...
		{desc: "invalid arg: net.IP must not be 0.0.0.0",
			conf: clusterconf.DHCPConfig{
				Duration: 1,
				Net: net.IPNet{
					IP: net.IPv4zero,

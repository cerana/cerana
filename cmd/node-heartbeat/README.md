...
[![node-heartbeat](https://godoc.org/github.com/cerana/cerana/cmd/node-heartbeat?status.svg)](https://godoc.org/github.com/cerana/cerana/cmd/node-heartbeat)

Usage:

    Usage of ./node-heartbeat:
